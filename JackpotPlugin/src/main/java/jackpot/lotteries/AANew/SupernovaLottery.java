...
public class SupernovaLottery implements jackpot.lotteries.AANew.Lotteries {
    private final SupernovaConfig cfg;
    ...
    public SupernovaLottery(){
        this.cfg = new SupernovaConfig();
        this.color = new Colors();
        this.maps = plugin.getLotteryMaps();
    }
    public SupernovaConfig getSupernovaConfig(){
        return this.cfg;
    }
    @Override
    ...
    public HashMap<UUID, Integer> getLotteryParticipantTicketPair() {
        return maps.getSupernovaMap();
    }
    public void clearMap(){
        maps.clearSupernovaMap();
    }
    @Override
    ...
    public void buyTickets(Player p, int amount) {
        ...
        maps.supernovaMapPut(p.getUniqueId(),amount+has);
    }
