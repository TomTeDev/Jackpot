...
public class MadmanLottery implements Lotteries {
    private final MadmanConfig cfg;
    private final LotteryMaps maps;
    private final Colors color;
    private final static jackpot.lotteries.Lotteries plugin = jackpot.lotteries.Lotteries.getPlugin(jackpot.lotteries.Lotteries.class);
    private final Economy economy = jackpot.lotteries.Lotteries.getEcon();
    public MadmanLottery(){
        this.cfg = new MadmanConfig();
        this.color = new Colors();
        this.maps = plugin.getLotteryMaps();
    }
    public MadmanConfig getMadmanConfig(){
        return this.cfg;
    }
    @Override
    ...
    public void finishLottery(Player p) {
        ...
        if(p!=null){
            p.sendMessage(ChatColor.GREEN+"Lottery finished!");
        }
    ...
    public void buyTickets(Player p, int amount) {
        ...
        maps.madmanMapPut(p.getUniqueId(),amount+has);
    }
